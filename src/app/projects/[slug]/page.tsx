    ...
    <ToastProvider>
      ...
      <div className="relative min-h-[70vh]">
        ...
        <div className="max-w-[860px] mx-auto px-5 pt-12 pb-20 relative">
          <Link href="/#projects" className="bp-btn-outline mb-8 inline-flex">
            <ArrowLeft size={14} /> back_to_projects
          </Link>

          <div className="bp-eyebrow mb-3">table: projects / row: {project.id}</div>
          ...
          <p className="font-mono text-cyan text-sm mb-7">{project.tagline}</p>

          {project.image && (
            <div className="bp-card overflow-hidden mb-8 relative aspect-[16/9]">
              <Image
                src={project.image}
